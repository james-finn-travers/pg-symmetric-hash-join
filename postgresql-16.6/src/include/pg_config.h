...
#define CONFIGURE_ARGS " '--prefix=/home/james/csi3130_project-1/.pg16-install' '--without-icu'"
...
#define PG_VERSION_STR "PostgreSQL 16.6 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04.3) 11.4.0, 64-bit"
