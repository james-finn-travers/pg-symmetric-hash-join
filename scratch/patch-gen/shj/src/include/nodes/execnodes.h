...
typedef struct HashJoinState
{
	...
	/* Symmetric hash join: second hash table for the outer relation */
	HashJoinTable hj_OuterHashTable;
	TupleTableSlot *hj_OuterHashTupleSlot;
	HashJoinTuple hj_OuterCurTuple;
	uint32		hj_OuterHashValue;
	int			hj_InnerBucketNo;
	int			hj_OuterBucketNo;
	bool		hj_InnerFinished;
	bool		hj_OuterFinished;
	bool		hj_ReadInnerNext;
	long		hj_InnerMatchCount;
	long		hj_OuterMatchCount;
	int			hj_CurrentTable;	/* 0 = probe inner, 1 = probe outer */
